...
<body>
  <div class="biometricmap">
    ...
    <div class="biometric-mapping">/Clothing Sizes</div>
    ...
    <div style="position: absolute; margin-top: -20px; width:1950px; overflow-y:auto; height:450px;">
      <table class="data" id="attendanceTable" style="margin-left:auto; margin-right:auto;">
        <tr class='header-row'>
          ...
          <th class='static-cell'>Shirt Size</th>
          <th class='static-cell'>Trouser Size</th>
        </tr>
        <?php
    ...
    <h3 class="userid-mapping" style="width:300px;">Clothing Sizes</h3>
    <img class="line-icon" alt="" src="./public/line-12@2x.png" />

    <label class="employee-name">Employee Name*</label>
    <label class="user-id">T-Shirt Size</label>
    <label class="user-id" style=" margin-left: 150px;">Trouser Size</label>
    <form id="updateForm">
      ...
      <select name="tshirt" id="" class="biometricmap-child1" style="width: 100px;">
        <option value="small">Small</option>
        <option value="medium">Medium</option>
        <option value="large">Large</option>
        <option value="xlarge">X-Large</option>
      </select>
      <select name="trouser" id="" class="biometricmap-child1" style="width: 100px; margin-left: 150px;">
        <option value="">--</option>
  ...
  <script>
    $(document).ready(function() {
      $("#updateForm").submit(function(e) {
        ...
        var tshirt = $("select[name='tshirt']").val();
        var trouser = $("select[name='trouser']").val();

        $.ajax({
          type: "POST",
          url: "insert_uniform.php",
          data: {
