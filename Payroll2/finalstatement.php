...
<body>
  <div class="attendence4">
    ...
    <div class="rectangle-parent23" style="margin-top: -60px; scale:0.9;">
...
") or die(mysqli_error($con));
                  ...
                  $totalLeavesValue1 = $cclValue +  $cslValue + $ccoValue;
                  $tds= 0 ;
                  $flop = $row['flop'];
                  // $epf1= $row['epf1'];
            ...
            ?>
              ...
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td colspan="24" class="px-6 py-4 text-center">No Data</td>
              </tr>
            <?php
            }
            ...
            ?>
             ...
             <button style="position:sticky; left:-20px; margin-top:10px;" type="button" onclick="submitFormData()" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
          Submit
        </button>
          </form>
    </div>
