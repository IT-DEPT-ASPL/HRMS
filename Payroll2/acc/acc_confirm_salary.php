      ...
      <div style="position: absolute; right: 0; top: -90px; background-color: white; width: 460px; height: 134px; border-radius: 7px;  box-shadow: 0 4px 4px rgba(0, 0, 0, 0.2); display: flex;">
        ...
        <div>
          <div style="display: flex; gap: 10px; margin-left: 20px; margin-top: 10px;">
            ...
            <p style="color: #666666; font-size: 20px; margin-top: 2px;">- 22</p>
          </div>
          <div style="display: flex; gap: 10px; margin-left: 20px; margin-top: 10px;">
            <div style="background-color: #d3d3d3; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; border-radius: 5px; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.2);">
            ...
            <p style="color: #666666; font-size: 20px; margin-top: 2px; margin-left: 10px;">- 19</p>
          </div>
          <div style="display: flex; gap: 10px; margin-left: 20px; margin-top: 10px;">
            <div style="background-color: #d3d3d3; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; border-radius: 5px; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.2);">
              <img src="../public/rectified.png" width="25px" alt="">
            </div>
            <p style="color: #666666; font-size: 18px; margin-top: 3px;">Rectified Employees</p>
            <p style="color: #666666; font-size: 20px; margin-top: 2px; margin-left: 13px;">- 10</p>
          </div>
        </div>
      </div>
      ...
      <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700" style="width: 130%;">
          ...
          <div class="p-4 md:p-5 text-center">
            ...
            <p style="font-size: 18px; margin-top: 8px;"><span style="color: rgb(145, 145, 145);">
            Name:</span> <span id="empnameInSecondModal" style="margin-left: 120px; font-size:17px; margin-bottom: 10px;"></span></p>
            <label for="message" style="text-align: start; margin-left: 20px; color: rgb(145, 145, 145); font-size: 18px; font-weight: normal; margin-top: 10px;" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reason:</label>
