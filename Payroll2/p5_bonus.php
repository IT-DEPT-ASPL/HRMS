        ...
        <div class="rectangle-parent23">
            <div id="marketing-banner" style="position:absolute; top:-30px; margin-left:-235px;" tabindex="-1" class="flex justify-between w-[calc(110%-2rem)] p-4 -translate-x-1/2 bg-white border border-gray-100 rounded-lg shadow-sm lg:max-w-7xl left-1/2 dark:bg-gray-700 dark:border-gray-600">
                <div class="flex flex-col items-start mb-3 me-4 md:items-center md:flex-row md:mb-0">
                    ...
                    <p class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">In this step, HR should allocate any bonuses or incentives to eligible employees based on company policies and performance criteria. This includes calculating bonus amounts, determining eligibility, and communicating bonus information to employees.
                    </p>
                </div>
            </div>
                ...
                <div style="position:absolute; height:700px; overflow-y:auto; margin-top:50px; width:100%;">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        ?>
                                <tbody>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <td class="px-6 py-4"><img src="./public/Bank.png" width="50px" style="border-radius: 50%;" alt=""></td>
                                        <td class="px-6 py-4"><?php echo $result['empname']; ?></td>
