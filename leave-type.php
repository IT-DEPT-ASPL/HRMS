  ...
  <body>
    <div class="applyleave">
      ...
      <div class="rectangle-parent9" style="margin-left: 120px;">
        ...
        <a class="assign-leave1" id="assignLeave">Approvers</a>        <a href="./leave-type.php" class="assign-leave1" style="margin-left: -485px; width: 200px; color: #ff5400;" id="assignLeave">New Leave Type</a>
      ...
      <div class="rectangle-parent10" style="margin-left: 270px;">
        ...
        <form id="updateForm">
        <input class="frame-child108" type="text" name="leavetype" oninput="convertToUpperCase(this)"/>
...
<table class="data" style="margin-top: 400px;">
    ...
    while ($result = mysqli_fetch_assoc($que)) {
        ...
        <tr>
            ...
            <td >
                <a href="delete_lt.php?id=<?php echo $result['id']; ?>" onclick="return confirm('Are you sure you want to delete this Shift?');"><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#FB8A0B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a>
            </td>
        </tr>
        <?php $cnt++;
    } ?>
