...
<body>
  <div class="attendence4">
    ...
    <div class="rectangle-parent22" style="margin-left:60px;">
      ...
      <a class="my-attendence4" id="myAttendence" style="margin-left: -150px; width:200px;">Break In/Out Log</a>
    ...
    <div class="rectangle-parent23" style="overflow-y:auto; margin-top:40px; margin-left:-40px; width:78%;">
...
ORDER BY CamsBiometricAttendance.AttendanceTime DESC";
        ...
        ?>
            ...
            WHERE emp.empname = '$empname'";
              ...
              <!-- <td style="border-left: 2px solid rgb(182, 182, 182); width:130px;white-space:nowrap;">
                ...
                if (($hours * 60 + $minutes) < $durationMinutes) {
                  if (isset($differenceHours) && isset($differenceMinutes)) {
    ...
    <a href="./Payroll/payroll.html" class="payroll14" style="text-decoration:none; color:black;">Payroll</a>
