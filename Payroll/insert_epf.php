...
$targetDir = "docs/";
$fileName = basename($_FILES["epfdoc"]["name"]);
...
if (!empty($fileName)) {
    ...
    if (in_array($fileType, $allowTypes)) {
        ...
        if (move_uploaded_file($_FILES["epfdoc"]["tmp_name"], $targetFilePath)) {
            // Insert file name into database
            $sql = "INSERT INTO payroll_epf (salmonth, tdate, notes, epfdoc, created) VALUES ('$salmonth', '$tdate', '$notes', '$fileName', '$created')";
