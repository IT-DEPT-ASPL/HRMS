...
?>
      ...
      <div style="position: absolute; background-color: #fcfbff; border: 1px solid #dadada; width: 300px; height: 60px; border-radius: 10px; margin-left: 690px; margin-top: 20px; border: 1px solid #e7e7e7; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.2);">
      ...
      <div style="position: absolute; background-color: #fcfbff; border: 1px solid #dadada; width: 300px; height: 60px; border-radius: 10px; margin-left: 690px; border: 1px solid #e7e7e7; top: 180px; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.2);">
      ...
      <div style="position: absolute; background-color: #fcfbff; border: 1px solid #dadada; width: 300px; height: 60px; border-radius: 10px; margin-left: 1010px; margin-top: 20px; border: 1px solid #e7e7e7; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.2);">
        <div style="position: absolute; display: flex; align-items: center; justify-content: center; background-color: #ffffff; border-radius: 5px; width: 45px; height: 45px; left: 10px; top: 6px;">
           <img src="public/pdf.svg" alt="">
        </div>
      ...
      <a href="exportCSV_main.php">
        <div style="position: absolute; background-color: #fcfbff; border: 1px solid #dadada; width: 300px; height: 60px; border-radius: 10px; margin-left: 1010px; border: 1px solid #e7e7e7; top: 180px; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.2);">
        <div style="position: absolute; display: flex; align-items: center; justify-content: center; background-color: #ffffff; border-radius: 5px; width: 45px; height: 45px; left: 10px; top: 6px;">
    ...
    <?php
      ...
      <div style="margin-top: 200px;">
        <table style="border: 1px solid rgb(219, 219, 219); box-shadow: 0 4px 4px rgba(0, 0, 0, 0.2);" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 rounded-lg border">
          ...
          <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td class="px-6 py-4" style="padding-bottom: 55px;">
                ...
                <span style="position: absolute; left: 362px; top: 346px;">EPF <br> ₹<?php echo $sumEpf; ?></span>
              </td>
              <td class="px-6 py-4">
                ...
                <span style="position: absolute; left: 646px; top: 346px;">ESIC <br>  ₹<?php echo $sumEsi; ?></span>
              </td>
              <td class="px-6 py-4">
                <div style="position: absolute; display: flex; align-items: center; justify-content: center; background-color: #ffe8df; border-radius: 50%; top: 340px; width: 50px; height: 50px;">
                  <img src="./public/EPFESIC.svg" width="20px" alt="">
                </div>
                <span style="position: absolute; left: 930px; top: 346px;">OTHERS <br> ₹<?php echo $sumEmi; ?></span>
              </td>
              <td class="px-6 py-4">
                ...
                <span style="position: absolute; left: 1213px; top: 346px;">TOTAL <br> ₹<?php echo $total; ?></span>
              </td>
              <td class="px-6 py-4">
                ...
                <span style="position: absolute; left: 80px; top: 346px;">BANK TRANSFER <br> ₹<?php echo $sum; ?> </span>
              </td>
            </tr>
          </tbody>
        </table>
