...
?>
            ...
            <div>
                ...
                <p style="font-size: 16px; font-weight: normal;">EPF <sup>2*</sup><span style="margin-left: 176px;">-</span> <span style="margin-left: 80px;">₹<?php echo $row['epf3']; ?>/-</span></p>
                <p style="font-size: 16px; font-weight: normal;">ESIC <span style="margin-left: 170px;">-</span> <span style="margin-left: 80px;">₹<?php echo $row['esi2']; ?>/-</span></p><hr style="width:70px; margin-left:290px; margin-top:10px;" />
                <p style="font-size: 16px; font-weight: normal;margin-top:10px;">Total Additions <span style="margin-left: 80px;">-</span> <span style="margin-left: 80px;">₹<?php echo $total_eycontributions ?>/-</span></p>
