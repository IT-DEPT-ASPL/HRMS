...
<script>
  document.getElementById('runPayrollBtn').addEventListener('click', function(event) {
    ...
    // Define array of dynamic texts with inline styles
    var dynamicTexts = [
      '<span style="color: #F9830D;">Data Collection and Validation</span>', 
      '<span style="color: #F9830D;">Data Allocation and Processing</span>', 
      '<span style="color: #F9830D;">Package Preparation and Bundling</span>', 
      '<span style="color: #F9830D;">Response Generation and Delivery</span>', 
      '<span style="color: #F9830D;">Process started !!!</span>'
    ];

    // Show SweetAlert2 loading animation
    Swal.fire({
      title: 'Initiating Payroll Run',
      html: dynamicTexts[0], // Initial text
      ...
      didOpen: () => {
        ...
        var intervalId = setInterval(() => {
          ...
          if (currentIndex < dynamicTexts.length) {
            Swal.update({ html: dynamicTexts[currentIndex] });
          }
        }, 1500);
