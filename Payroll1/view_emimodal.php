...
?>
      ...
      <div class="p-4 md:p-5 space-y-4">
        ...
        <hr>
        <p style="font-size: 18px;"><span style="color: rgb(145, 145, 145);">Loan ID</span> <span style="margin-left: 105px;"><?php echo $row['loanno']; ?></span></p>
        <hr>
        <p style="font-size: 18px;"><span style="color: rgb(145, 145, 145);">EMI Amount</span> <span style="margin-left: 65px;">₹ <?php echo $row['emi']; ?>/-</span></p>
        <hr>

        <p style="font-size: 18px;"><span style="color: rgb(145, 145, 145);">Month</span> <span style="margin-left: 65px;"><?php echo $currentMonth; ?></span></p>
        <hr>
  ...
  $(document).ready(function() {
    $('#employeeEMI').submit(function(e) {
      ...
      Swal.fire({
        ...
        confirmButtonText: 'Yes, dedcut EMI',
