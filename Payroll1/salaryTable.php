...
<body>
    <div class="attendence4">
        ...
        <div class="rectangle-parent23" style="margin-top: -60px;">
            ...
            $count4 = $row4['count'];
            ?>
            <div style="border: 2px solid rgb(224, 224, 224); background-color: rgb(250, 253, 255); font-size: 18px; width: 270px; margin-bottom: 20px; padding: 8px; border-radius: 5px;">Total Active Employee's = <?php echo $count4; ?></div>
            ...
            <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white">
                ...
                <div id="accordion-color-body-1" class="hidden bg-gray-50" aria-labelledby="accordion-color-heading-1">
                    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                        <p class="mb-2 text-gray-500 dark:text-gray-400">This table provides a comprehensive overview of the components comprising an employee's fixed salary. It encompasses base pay, allowances, and deductions, providing transparency and clarity regarding the fundamental components of an individual's compensation package</p>
                    </div>
                </div>
            </div>
     ...
     ";
           ...
           (SELECT SUM(bp) FROM payroll_msalarystruc) AS total_abp";
                    ...
                    <tfoot class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-6 py-4" style="text-align: center; font-size: 15px; border-left: 1px solid rgb(224, 224, 224); font-weight: 500;">Total : ₹ wait/-</td>
