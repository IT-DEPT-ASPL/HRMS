...
<body>
  <div class="attendence4">
    ...
    <div class="rectangle-parent22" style="margin-left: -80px;">
      ...
      <a class="frame-child189" style="background-color: #ffe2c6;" id="rectangleLink1" href="lop.html"> </a>
      ...
      <a class="records5" id="records" style="margin-left: -10px; width: 110px; margin-top: -4px; color: #ff6e24;" href="lop.php">Loss Of Pay</a>
      <a class="punch-inout4" id="punchINOUT" style="margin-left: 40px; margin-top: -4px;" href="bonus.php">Bonus</a>
      <a class="my-attendence4" href="misc.php" id="myAttendence" style="margin-left: 30px; margin-top: -4px;  ">Advances</a>
...
") or die(mysqli_error($con));
    ...
    ?>
    <select style="position: absolute;font-size:20px; border: 1px solid #e8e8e8; background-color:#fcfcfc; border-radius:5px; left:440px; top:170px;" id="monthYearSelect" onchange="filterData()">
    ...
    ?>
    <div style="position:absolute; left:440px; top:220px; border: 1px solid #e8e8e8; background-color:#fcfcfc; border-radius:5px; width:450px; height:150px; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.5);">
    ...
    <div style="position:absolute; left:49%; top:220px; border: 1px solid #e8e8e8; background-color:#fcfcfc; border-radius:5px; width:450px; height:150px; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.5);">
    ...
    <div style="position:absolute; right:30px; top:220px; border: 1px solid #e8e8e8; background-color:#fcfcfc; border-radius:5px; width:450px; height:150px; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.5);">
   ...
   ORDER BY total_flop DESC";
    ...
    <div class="rectangle-parent23" style="height: 60vh;overflow-y: auto;display:block; margin-top:200px;">
