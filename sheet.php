...
") or die(mysqli_error($db));
                            ...
                            $fetchingHolidaysa = mysqli_query($db, "
                            SELECT date
                            FROM holiday
...
") or die(mysqli_error($db));
                            ...
                            echo "<td style='background-color:rgb(1, 100, 255);color:white;text-align:center;'>$totalleavesCount1</td>";
...
<script>
    function filterData() {
        ...
        if (selectedMonthYear !== "") {
            ...
            xhttp.open("GET", "fetch_attendance.php?monthYear=" + selectedMonthYear, true);
            xhttp.send();
        }
    }
