...
<div id="pdfContainer" style="display: none;">
    <div style="outline: 1px solid #AAAAAA; width: 92%; scale:0.8;margin-left:-80px;margin-top: 20px;">
        ...
        <a id="downloadLink" href="#" download>
            <img src="https://ik.imagekit.io/7oaqyvwnm/download-removebg-preview.png?updatedAt=1704189420897"
                 alt="Download" style="width: 20px; height: 20px; margin-left: 20px; margin-top: -8px;">
        </a>
